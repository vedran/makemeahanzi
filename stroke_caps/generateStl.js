...
function generateOpenScad(char, options = {}) {
  ...
  const romanAreaHeight = 25; // Space for romanization text at bottom (mm)
  const plateHeight = romanization ? PLATE_SIZE_MM + romanAreaHeight : PLATE_SIZE_MM;
  const romanTextSize = 10; // Text size in mm
  const romanTextY = 10; // Distance from bottom edge to text baseline (mm)
